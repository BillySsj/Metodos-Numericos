...
function entrada_biseccion(){
    ...
    var b1 = document.getElementById('btn-1'); b1.style.display ="block"; 
    var b2 = document.getElementById('btn-2'); b2.style.display ="none"; 
    var b3 = document.getElementById('btn-3'); b3.style.display ="none"; 
    var b4 = document.getElementById('btn-4'); b4.style.display ="none"; 
    var b5 = document.getElementById('btn-5'); b5.style.display ="none"; 
}
function entrada_regla(){
    global = 2; 
    var formulario = document.getElementById('formulario'); 
    formulario.style.display = "block"; 
    var main = document.getElementById('main'); 
...
function entrada_newton(){
        ...
        var tabla = document.getElementById('formulario'); 
        tabla.style.display ="flex"; 
        var main = document.getElementById('main'); 
        main.style.display ="none"; 
        document.getElementById('label1').innerHTML="Valor Inicial"; 
        ...
        document.getElementById('e-5').innerHTML = "TOLERANCIA"
        document.getElementById('label1').innerHTML = "Valor Inicial"
        document.getElementById('intervalo').value = "";
        document.getElementById('funcion').value = "";
        document.getElementById('Limite').value = "";
        var b1 = document.getElementById('btn-1'); b1.style.display ="none"; 
        var b2 = document.getElementById('btn-2'); b2.style.display ="block"; 
        var b3 = document.getElementById('btn-3'); b3.style.display ="none"; 
        var b4 = document.getElementById('btn-4'); b4.style.display ="none"; 
        var b5 = document.getElementById('btn-5'); b5.style.display ="none"; 
}
function entrada_secante(){
    ...
    var main = document.getElementById('main'); 
    main.style.display = "none"; 
   document.getElementById('label1').innerHTML = "Xo, Xi"
   var b1 = document.getElementById('btn-1'); b1.style.display ="block"; 
   var b2 = document.getElementById('btn-2'); b2.style.display ="none"; 
   var b3 = document.getElementById('btn-3'); b3.style.display ="none"; 
   var b4 = document.getElementById('btn-4'); b4.style.display ="none"; 
...
function entrada_nmejorado(){
  ...
  document.getElementById('e-6').innerHTML = "Tolerancia";
  var b1 = document.getElementById('btn-1'); b1.style.display ="none"; 
  var b2 = document.getElementById('btn-2'); b2.style.display ="none"; 
  var b3 = document.getElementById('btn-3'); b3.style.display ="none"; 
  var b4 = document.getElementById('btn-4'); b4.style.display ="block"; 
  var b5 = document.getElementById('btn-5'); b5.style.display ="none"; 
...
function entrada_Interpolacion(){
    var main = document.getElementById('main'); 
    main.style.display ="none"; 
    var int = document.getElementById('interpol'); 
    int.style.display ="flex"; 
}
function entrada_inter_newton(){
        var int = document.getElementById('main'); 
        ...
        var b3 = document.getElementById('btn-3'); b3.style.display ="none"; 
        var b4 = document.getElementById('btn-4'); b4.style.display ="none"; 
        var b5 = document.getElementById('btn-5'); b5.style.display ="block"; 
}
function entrada_inter_laranje(){
    var int = document.getElementById('main'); 
    int.style.display="none"; 
    global = 7;
    var formulario = document.getElementById('formulario');
...
function Entrada_Miller() {
   document.getElementById('label1').innerHTML = "X0 Xi X2"
    var main = document.getElementById('main');
    main.style.display="none"; 
    var formulario = document.getElementById("formulario");
    formulario.style.display ="block"; 
    var b1 = document.getElementById('btn-1'); b1.style.display ="none"; 
    var b2 = document.getElementById('btn-2'); b2.style.display ="none"; 
    var b3 = document.getElementById('btn-3'); b3.style.display ="block"; 
    var b4 = document.getElementById('btn-4'); b4.style.display ="none"; 
    var b5 = document.getElementById('btn-5'); b5.style.display ="none"; 
    ...
    document.getElementById('e-15').innerHTML = "Error";
    var i = 1;
    var o = 8;
    while (i < 9) {
...
function Resolver_miller() {
    ...
    vamos.style.width = "1150px";
    vamos.style.marginLeft = "20px";
  ...
  function resolver_N_mejorado() {
    ...
    var vamos = document.getElementById("resultados");
    vamos.style.display="block"; 
    vamos.style.marginLeft ="30px"; 
    vamos.style.width ="550px"
    var resultados = document.getElementById("resultadosTabla2");
    resultados.style.display = "block"
    resultados.style.mar
  ...
  function Resolver_inter_newton() {
    var formulario = document.getElementById("formulario");
    formulario.style.display ="none"; 
    var ver = document.getElementById('Interpolacion-new'); 
    ver.style.display ="block"; 
    inter.style.marginLeft = "350px";
    var valor_funcion = document.getElementById('funcion').value;
    var concatenate = valor_funcion + "R";
    var chain = "R";
    var confirmation = true;
    ...
    var x2 = termino;
    var y2 = termino2;
    var x1 = parseFloat(document.getElementById('Cantidad' + red).textContent);
    var y1 = parseFloat(document.getElementById('CantidadYY' + red).textContent);
    if (global == 6) {
